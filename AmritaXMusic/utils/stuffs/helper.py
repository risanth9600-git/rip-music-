...
/mmf ➠ ʀᴇʟᴘʏ ᴀɴʏ sᴛɪᴄᴋᴇʀ ɢᴇᴛ ᴀ ɴᴇᴡ ɴᴀᴍᴇ ʟɪᴋᴇ /mmf ᴀᴍʀɪᴛᴀxᴍᴜꜱɪᴄ  
'''
...
๏ ᴛᴇᴍᴘᴏʀᴀʀʏ ᴏꜰꜰ ᴛᴀɢ ᴀʟʟ ᴄᴏᴍᴍᴇɴᴛꜱ 😅🍷
...
/allrepo : sᴇᴇ ᴀʟʟ ʀᴇᴘᴏ ᴀɴʏ ɢɪᴛʜᴜʙ ᴀᴄᴄᴏᴜɴᴛ ᴇx - /allrepo ᴛʜᴇ ᴀʀᴄʜɪᴛᴇᴄᴛ.
...
◌ /love : ᴀᴅᴅ ᴛᴡᴏ ɴᴀᴍᴇs ᴀɴᴅ sᴇᴇ ʟᴏᴠᴇ ᴘᴏssɪʙɪʟɪᴛʏ! ʟɪᴋᴇ ᴠɪᴋʀᴀᴍ + ᴀᴍʀɪᴛᴀ 
